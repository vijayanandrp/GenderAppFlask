...
data_process(file_name=male_file, gender='M', output_file='male_names_parsed.txt')
data_process(file_name=female_file, gender='F', output_file='female_names_parsed.txt')
